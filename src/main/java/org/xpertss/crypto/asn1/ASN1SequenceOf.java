 ...
 *
 * Constraints are checked only after decoding by a call to
 * method {@link #decode decode}.
 */
public class ASN1SequenceOf extends ASN1Sequence implements ASN1CollectionOf {
   ...
   /**
    * Creates an instance that keeps elements of
    * the given type. The type must be a valid
    * {@link ASN1Type ASN1Type}. The given class
    * must be public and it must have a public
    * default constructor.
    *
    * @param type The class that represents the component type
    *   of this SET OF.
    * @exception IllegalArgumentException if the given class
    *   does not implement ASN1Type.
    ...
    * of the elements in this collection or <code>ASN1Type.class
    * </code> if the type cannot be determined.
    *
